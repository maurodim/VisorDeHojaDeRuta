...
public class EditorDePedidos extends javax.swing.JInternalFrame {
    ...
    public EditorDePedidos(ArrayList pedidosSel) {
        ...
        int columna=0;
            while(il.hasNext()){
                ...
                fila[10]=0.00;
                this.jTextField1.setText(ped.getObservaciones());
                this.jTextField2.setText(ped.getObservaciones1());
                this.jTextField3.setText(ped.getObservaciones2());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Renglon 1");

        jLabel4.setText("Renglon 2");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jComboBox1, javax.swing.GroupLayout.Alignment.LEADING, 0, 289, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        */
        while(ill.hasNext()){
            ...
            ped.setObservaciones1(observaciones1);
            ped.setObservaciones2(observaciones2);
            ped.setMarcadoParaProceso(marcadoProceso);
            ped.setMarcadoParaReparto(marcadoReparto);
...
//jTable1.removeAll();
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
       if(evt.getKeyCode()==KeyEvent.VK_ENTER){
           ...
           PedidosParaReparto pedi=(PedidosParaReparto) listadoDePedidos.get(posicion);
           Double cantidadM=(Double) jTable1.getValueAt(posicion,5);
           if(cantidadM <= pedi.getCantidadArticulo() && cantidadM > 0){
               pedi.setCantidadArticulo(cantidadM);
           }else{
               JOptionPane.showMessageDialog(null,"Por favor introducir una cantidad menor a la permitida");
               jTable1.setValueAt(pedi.getCantidadArticulo(),posicion,5);
           }
       }
